...
----------------------------------
Base HTTP client for pktlog acting as a suite-token CLIENT of a sibling
pkt* app. No consumer feature uses this yet (see app/api/integrations.py)
— this is the same reusable client pktIPAM/pktflow/pktWiFi already have.
...
log = logging.getLogger("pktlog.integrations")


class SuiteClient:
    def __init__(self, base_url: str, suite_token: str, suite_user: str = "pktlog", suite_role: str = "admin"):
