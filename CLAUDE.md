...
**Live URL:** https://10.20.30.5:8768
...
|------|----|------|---------|
| pkt server | 10.20.30.5 | ec2-user | `C:\Users\user\.ssh\corporate_infrastructure.pem` |
...
- Collectors: Medical (10.20.30.11) and Dental (10.20.30.181) syslog-ng forwarding to pkt server:8761 with disk-buffer
